...
public class RegularPendulum extends AbstractPendulum {
     ...
     */
    public RegularPendulum (double inLength, double inMass, double inTheta0, GravityModel model,
		     double inDelta, double inDiss) {
	super (inLength, inMass, inTheta0,model);
	delta=inDelta;
	dissipation = inDiss;
	lastVel = 0;
    ...
    public RegularPendulum (double inLength, double inMass, double inTheta0, GravityModel model,
		     double inDelta) {
	this (inLength, inMass, inTheta0, model, inDelta, 0);
    }
